...
public class YoungPostListController implements Controller {
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		if (pageNo==null) {
			...
			ArrayList<BBSVO> list=BBSDAO.getInstance().getPostingYoungList(pagingBean);
			ListVO listVO=new ListVO(list, pagingBean);
			request.setAttribute("lvoy", listVO);
		...
		request.setAttribute("url", "/bbs/BBSYoungList.jsp");
