...
public class OldPostListController implements Controller {
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		if (pageNo==null) {
			...
			ArrayList<BBSVO> list=BBSDAO.getInstance().getPostingOldList(pagingBean);
			ListVO listVO=new ListVO(list, pagingBean);
			request.setAttribute("lvoo", listVO);
		...
		request.setAttribute("url", "/bbs/BBSOldList.jsp");
