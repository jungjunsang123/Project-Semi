				...
				<div class="card">
					...
					<div class="container">
						<table class="table table-bordered" style="text-align:center;">
							...
							<tbody>
								<%-- 게시글 데이터 --%>
								<c:forEach var="pvo" items="${requestScope.lvoy.list}" varStatus="status">
									<tr>
										<td class="text-center">${fn:length(requestScope.lvoy.list)-status.index}</td>
										<td><c:choose>
							...
							<div class="pagingArea col-sm-4">
								...
								<ul class="pagination">
									...
									<c:forEach var="i" begin="${pb.startPageOfPageGroup}"
										...
										<c:choose>
											<c:when test="${empty requestScope.lvoy.list}"></c:when>
